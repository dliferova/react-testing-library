...
import { ValidationErrors } from "../global/enums.ts"
...
describe("Validation errors unit tests", () => {
  ...
  test("Show empty email error message", async () => {
    ...
    let requiredEmailErrorElem = screen.queryByText(
      ValidationErrors.requiredEmail,
    )
  ...
  test("Show empty password error message", async () => {
    ...
    let requiredPasswordErrorElem = screen.queryByText(
      ValidationErrors.requiredPassword,
    )
    ...
    requiredPasswordErrorElem = screen.queryByText(
      ValidationErrors.requiredPassword,
    )
  ...
  test("Show empty confirm email error message", async () => {
    ...
    let requiredConfirmPasswordErrorElem = screen.queryByText(
      ValidationErrors.requiredConfirmPassword,
    )
    ...
    requiredConfirmPasswordErrorElem = screen.queryByText(
      ValidationErrors.requiredConfirmPassword,
    )
  ...
  test("Show validation error in case of too short confirm password", async () => {
    ...
    const { formSubmitButton, passwordInput, confirmPasswordInput } =
      renderAppAndForm()

    let confirmPasswordErrorElem = screen.queryByText(
      ValidationErrors.shortConfirmPassword,
    )
    ...
    confirmPasswordErrorElem = screen.queryByText(
      ValidationErrors.shortConfirmPassword,
    )
  ...
  test("Show unselect privacy policy checkbox validation message", async () => {
    ...
    let privacyPolicyErrorElem = screen.queryByText(
      ValidationErrors.requiredPrivacyPolicy,
    )
    ...
    privacyPolicyErrorElem = screen.queryByText(
      ValidationErrors.requiredPrivacyPolicy,
    )
